...
print("\n3- Crie um programa de cálculo de volume de uma caixa retangular.")
...
print("\n4- Crie um programa de cálculo do preço total e exibir todas as informações")
